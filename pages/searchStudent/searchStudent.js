...
Page({
  ...
  dataRequest: function () {
    ...
    var params = {
      ...
      'choiceMajorId': this.data.majorId,
      'choiceSchooId': this.data.schoolId,
      'adjustMajorId1': this.data.adjustmajorId,
  ...
  setAdjustMajorIndex: function (e) { //服务城市一级索引
    const dataset = e.currentTarget.dataset;
    this.setData({
      adjustmajorindex: dataset.adjustmajorindex,
      adjustmajorId: dataset.adjustmajorid,
      adjustmajorName: dataset.adjustmajorname,
      showfilterindex: null,
      servicelist: [],
      pager: 1,
    })
  ...
  gostudentdetail: function (e) {
    ...
    wx.request({
      ...
      success: function (res) {
        console.log(res)
        wx.navigateTo({
          url: '../../pages/studentdetail/studentdetail?list=' + JSON.stringify(res.data),
        })
